...
async function welcome() {
    console.clear();
    const greenTitle = chalk.greenBright.bold(`Who is the Real Pakistani? \n`);
...
async function sayCongratulations() {
    const msg = "Congratulations, you're a real Pakistani";
    figlet(msg, (err, data) => {
        console.log(gradient.pastel.multiline(data));
    });
}
async function sayCongratulations2() {
    const msg = "Congratulations, you're not a real Pakistani";
    figlet(msg, (err, data) => {
        console.log(gradient.pastel.multiline(data));
    });
}
